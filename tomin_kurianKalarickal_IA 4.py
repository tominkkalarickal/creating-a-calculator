...
btn_clearing=tk.Button(btns_frame, text="Clear", fg="black", width=32, height=4, bd=0, bg="#eee", cursor="hand2", command=btn_clear)
...
btn_div= tk.Button(btns_frame, text="/", fg="black", width=11, height=4, bd=0, bg="#eee", cursor="hand2", command= lambda: btn_click("/"))
btn_div.grid(row=0, column=3, padx=1, pady=1)

#first row of button frame includes 4 buttons 7, 8, 9 and multiply (*):
...
# second row includes 4 buttons, 4,5,6 and subtract -:
...
#last row includes 0, ., =
tk.Button(btns_frame, text="0", fg="black",width=12, height=3, bd=0,bg="#fff", cursor="hand2", command=lambda: btn_click(0)).grid(row=4, column=0, columnspan=2, padx=1, pady=1)
